...
public class Cat1 extends Creature  {
    ...
    public Cat1(GameBase gameBase, int level) {
        ...
        if (mHangingSprite == null) {
            Bitmap tmpBitmap = BitmapFactory.decodeResource(game.res, R.drawable.cat1_hanging);
            mHangingSprite = new Sprite(Sprite.replaceColor(tmpBitmap, Sprite.ColorChannel.GREEN, Color.rgb(0x92, 0x3a, 0x00)), 18);
