...
public class UpArrow extends Button {
    ...
    public UpArrow(GameBase gameBase, String string) {
        super(gameBase);
        ...
        if (mArrowSprite == null) {
            mArrowSprite = new Sprite(BitmapFactory.decodeResource(game.res, R.drawable.arrow_up), 1);
        }
    ...
    public void update(final TimeStep timeStep) {
        ...
        mText.setPosition(getX(0.9), getY(0.5));
    }
