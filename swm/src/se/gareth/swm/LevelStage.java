...
public class LevelStage extends Stage {
    ...
    public void playfieldSizeChanged(int width, int height) {
    	...
    	mExitArrow.setPosition(mExitArrow.width / 1.5, height - mExitArrow.height / 1.5);
    	mNextArrow.setPosition(width - mNextArrow.width / 1.5, height - mNextArrow.height / 1.5);
    }
